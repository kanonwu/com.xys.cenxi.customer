...
import com.xys.cenxi.customer.ui.component.rating.RatingCmp;
...
public class CustomerMgrCmp extends Composite {
	...
	public CustomerMgrCmp(Composite parent, int style) {
		...
		new Label(searchCndCmp, SWT.NONE);
		new Label(searchCndCmp, SWT.NONE);
		new Label(searchCndCmp, SWT.NONE);
		new Label(searchCndCmp, SWT.NONE);
		new Label(searchCndCmp, SWT.NONE);
		...
		tabFolder.setSelectionBackground(Display.getCurrent().getSystemColor(SWT.COLOR_TITLE_INACTIVE_BACKGROUND_GRADIENT));
				...
				GridData gd_customCmp = new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1);
				gd_customCmp.heightHint = 194;
				customCmp.setLayoutData(gd_customCmp);
				customCmp.setSize(598, 189);
				new Label(customCmp, SWT.NONE);
				new Label(customCmp, SWT.NONE);
				new Label(customCmp, SWT.NONE);
				new Label(customCmp, SWT.NONE);
				new Label(customCmp, SWT.NONE);
